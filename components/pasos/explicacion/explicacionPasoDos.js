    ...
    return (
      <View style={styles.container}>
        <View style={styles.expoArriba}>
          ...
          <Image style={styles.balanza} source={require('../../../assets/gifs/zickzack.gif')}/>
        </View>
        <View style={styles.expoAbajo}>
          <Image style={styles.letrasBalanza} source={require('../../../assets/gifs/letrasZickZack.gif')}/>
          <TouchableHighlight>
            <Text style={styles.buttonText} onPress={() => navigate('PasoDos',{user:'PasoDos'})}>Ejecutar tarea</Text>
          </TouchableHighlight>
        </View>
      </View>
    );
